...
## Project Structure
    ...
    ├── pedestrians_detecto_31685  # Django project configurations
...
1. Clone this repo and `cd pedestrians_detecto_31685`
...
2. Clone this repo and `cd pedestrians_detecto_31685`
